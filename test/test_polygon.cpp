...
int main(int argc, char** argv) {
    ...
    try {
        ...
        double absPath_m{10};
        std::tie(abscissaCurve_m, curveId, std::ignore) = polygon->PathAbsToCurveAbs(absPath_m);
        ...
        std::tie(absPath_m, std::ignore) = polygon->CurveAbsToPathAbs(abscissaCurve_m, curveId);
