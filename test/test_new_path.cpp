...
int main() {
    ...
    try {
        ...
        newPath = PathFactory::NewNewPath(angle, direction, offsetPath, polygonVerteces);
        auto end = std::chrono::high_resolution_clock::now();
        PersistenceManager::SaveObj(newPath->Sampling(1500), "/home/antonino/Desktop/sisl_toolbox/script/path.txt");
